...
public class OrderDao {
	...
	public Person getPersonById(int personid) {
		String sql = "SELECT personid, lastname, firstname, address, city FROM CUSTOMER_ORDERS where personid =" + personid;
	...
	public void deleteField(int personid) {
		String sql = "Delete from CUSTOMER_ORDERS where personid = " + personid;
		jdbcTemplate.update(sql);
	}
		
	public void updateField(Person person) {
		String sql = "update CUSTOMER_ORDERS set lastname = ? where personid =" + person.getPersonId();
